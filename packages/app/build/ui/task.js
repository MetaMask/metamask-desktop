...
const {
  setupTaskDisplay,
} = require('../../submodules/extension/development/build/display');
const {
  logError,
...
function runInChildProcess(
  task,
  { applyLavaMoat, buildType, isLavaMoat, policyOnly },
) {
  ...
  return instrumentForTaskStats(taskName, async () => {
    const childProcess = spawn(
      ...
      [
        ...
        isLavaMoat ? 'build:ui:subtask:lavamoat' : 'build:ui:subtask',
        taskName,
