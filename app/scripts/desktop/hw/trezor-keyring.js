...
class TrezorKeyring extends EventEmitter {
  constructor(opts = {}) {
    ...
    TrezorConnect = {
      on(event, callback) {
        console.log('TREZORCONNECT DESKTOP on', { event, callback });
        ipcMain.emit('trezor-on', event, callback);
      },

      init(data) {
        console.log('TREZORCONNECT DESKTOP init', data);
        ipcMain.emit('trezor-init', data);
      },

      getPublicKey(data) {
        console.log('TREZORCONNECT DESKTOP getPublicKey', data);

        return new Promise((resolve, reject) => {
          ipcMain.emit('trezor-getPublicKey', data);

          ipcMain.on('trezor-connect-getPublicKey-result', (_, response) => {
            console.log('TREZORCONNECT DESKTOP RECEIVED getPublicKey');
            resolve(response);
          });
        });
      },
      ...
      ethereumSignTransaction(data) {
        console.log('TREZORCONNECT DESKTOP ethereumSignTransaction', data);
        ...
        return new Promise((resolve, reject) => {
          ...
          ipcMain.on(
            ...
            (_, response) => {
              console.log(
                'TREZORCONNECT DESKTOP RECEIVED ethereumSignTransaction',
              );
              resolve(response);
            },
          );
      ...
      ethereumSignMessage(data) {
        console.log('TREZORCONNECT DESKTOP ethereumSignMessage', data);
        ...
        return new Promise((resolve, reject) => {
          ...
          ipcMain.on(
            ...
            (_, response) => {
              console.log('TREZORCONNECT DESKTOP RECEIVED ethereumSignMessage');
              resolve(response);
            },
          );
        });
      ...
      ethereumSignTypedData(data) {
        console.log('TREZORCONNECT DESKTOP ethereumSignTypedData', data);
        ...
        return new Promise((resolve, reject) => {
          ...
          ipcMain.on(
            ...
            (_, response) => {
              console.log(
                'TREZORCONNECT DESKTOP RECEIVED ethereumSignTypedData',
              );
              resolve(response);
            },
          );
